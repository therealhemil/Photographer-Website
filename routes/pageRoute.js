...
// dynamically chnage portfolio page
router.get("/portfolio", pageController.DynamicallygetPortFolioImages)
// dynamically add and get images
router.get('/portfolio/:id', pageController.getportfolioExploreImages)
